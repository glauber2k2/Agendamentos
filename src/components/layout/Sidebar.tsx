  ...
  return (
    <div className={`items-start flex`}>
      <nav
        ...
        className={`data-[sidebar=false]:hidden dark:bg-system-darkness dark:text-system-50 xl:static xl:col-span-2 h-screen sm:flex flex-col py-8 gap-4 hidden shadow-sm px-8 bg-system-100 text-system-600`}
      >
        <div className='flex items-center gap-4'>
          ...
          <div className='flex flex-col'>
            <h1 className='font-extrabold text-xl overflow-hidden truncate text-ellipsis capitalize'>
              {companyName}
            </h1>
            <p className='font-light text-xs'>#1318EJDWA</p>
          </div>
        </div>
