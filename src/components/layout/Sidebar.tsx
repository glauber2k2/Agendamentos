...
import { Calendar, ChevronDown, Coins, Home } from 'lucide-react'
...
function Sidebar() {
  ...
  return (
    <motion.nav
      animate={{
        width: sidebarIsOpen ? '100%' : '100px',
      }}
      data-sidebar={sidebarIsOpen}
      className={`data-[sidebar=false]:block fixed dark:bg-system-darkness dark:text-system-50 h-screen  p-4 gap-4 hidden shadow-sm px-4 bg-system-100 text-system-600 `}
    >
